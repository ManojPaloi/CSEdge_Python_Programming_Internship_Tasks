...
class PDFConverterApp:
    def __init__(self, root):
        ...
        style.configure("TButton", font=("Helvetica", 12, "bold"), background='#1abc9c', foreground='#ffffff', padding=10)
        style.map("TButton", background=[('active', '#16a085')], foreground=[('active', '#ffffff')])
